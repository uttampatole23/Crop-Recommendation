...
<b>Software name: </b> Python: Version: <b>3.7.6</b>([Download link](https://www.python.org/downloads/windows/))<br>
<b>Software name: </b> Pycharm: Version: <b>2024.1.7</b>([Download link](https://www.jetbrains.com/pycharm/download/#section=windows))
<br>
...
## HOW TO RUN➿
    ...
    Step 2: Generate the graphs plotted in the paper
        1. current project window in pycharm, Open ‘Main_Analysis.py’, and click
        run button.
